...
- Path to `${CLAUDE_PLUGIN_ROOT}/aidlc-common/conventions/aidlc-folder-structure.md`
...
3. Determine output paths from `${CLAUDE_PLUGIN_ROOT}/aidlc-common/conventions/aidlc-folder-structure.md`.
...
- Generate clarifying questions using `${CLAUDE_PLUGIN_ROOT}/aidlc-common/conventions/aidlc-question-format.md`.
...
See `${CLAUDE_PLUGIN_ROOT}/aidlc-common/conventions/aidlc-state-schema.md` for the state file format, valid states, and transitions.
