...
3. `state/intent-state.md` exists and matches the header format defined in `${CLAUDE_PLUGIN_ROOT}/aidlc-common/conventions/aidlc-state-schema.md` (intent name, created/updated timestamps, Workflow Progress table header).
