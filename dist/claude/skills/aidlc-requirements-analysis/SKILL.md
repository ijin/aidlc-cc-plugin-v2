...
Validation rules for this skill's output live in `validation-spec.md` at the skill root. Deterministic post-condition scripts live in `scripts/`. See `${CLAUDE_PLUGIN_ROOT}/aidlc-common/protocols/aidlc-validator-protocol.md` for how they are applied.
