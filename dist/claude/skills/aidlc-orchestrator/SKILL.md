...
Read and follow `${CLAUDE_PLUGIN_ROOT}/aidlc-common/protocols/aidlc-orchestrator-protocol.md` — it is the single source of truth for your behaviour. It references the skill catalogue (`${CLAUDE_PLUGIN_ROOT}/skills/aidlc-orchestrator/CATALOGUE.md`) and conventions (`${CLAUDE_PLUGIN_ROOT}/aidlc-common/conventions/`) as needed.
