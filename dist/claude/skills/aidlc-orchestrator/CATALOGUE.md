...
Generic builder and validator behaviour lives in `${CLAUDE_PLUGIN_ROOT}/aidlc-common/protocols/aidlc-builder-protocol.md` and `${CLAUDE_PLUGIN_ROOT}/aidlc-common/protocols/aidlc-validator-protocol.md`. Per-skill folders only hold what differs between skills.
